...
for iteration in range(1, ITERATION+1):
    ...
    train_mse_loss =  torch.mean((train_predictions - train_label)**2)
    ...
    with torch.no_grad():
        ...
        validation_mse_loss = torch.mean((validation_predictions - validation_label)**2)
...
with torch.no_grad():
    ...
    test_loss = torch.mean((test_predictions - test_label)**2)
